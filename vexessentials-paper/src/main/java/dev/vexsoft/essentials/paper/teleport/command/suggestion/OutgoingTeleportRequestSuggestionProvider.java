...
/** Suggests targets with an outgoing pending teleport request. */
@Dependencies(TeleportRequestService.class)
public final class OutgoingTeleportRequestSuggestionProvider implements SuggestionProvider {

  private final TeleportRequestService requests;

  public OutgoingTeleportRequestSuggestionProvider(final VexServiceRegistry services) {
  ...
  public CompletableFuture<Suggestions> suggest(
    ...
    requests.getOutgoingSuggestions(player.getUniqueId()).stream()
